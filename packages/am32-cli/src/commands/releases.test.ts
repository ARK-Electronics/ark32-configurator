...
const NIGHTLY = {
    ...
    assets: [
        { name: 'ARK32_ARK_4IN1_F051_3.0.3.hex', browser_download_url: 'https://example.test/ark' },
        { name: 'ARK32_REF_G431_3.0.3.hex', browser_download_url: 'https://example.test/g431' }
    ]
};
...
describe('fetchFirmwareReleases', () => {
    it('maps the GitHub shape and remembers what it asked for', async () => {
        ...
        expect(releases).toEqual([{
            ...
            assets: [
                { name: 'ARK32_ARK_4IN1_F051_3.0.3.hex', downloadUrl: 'https://example.test/ark' },
